...
<div class="container">
	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="row">
				<h4 class="text-center">Товар статистика по площадкам в период с {{date('d-m-Y',strtotime($from))}} по {{date('d-m-Y',strtotime($to))}}</h4>
			    ...
			    <table class="table table-hover table-bordered" style="margin-top: 10px">
						<thead>
							...
							<tr>
								 ...
								 <td><a href="{{route('advert_statistic.pad_statistic', ['id'=>$pad_stat->pad])}}" data-toggle="tooltip" data-placement="bottom" title="Статистика по дням" target="_blank"><span class="glyphicon glyphicon-th news-gliph-all color-blue"></span></a></td>
