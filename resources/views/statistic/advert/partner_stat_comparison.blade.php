...
<div class="container">
	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="row">
				<h4 class="text-center">Товар статистика по партнёрам в период с {{date('d-m-Y',strtotime($from))}} по {{date('d-m-Y',strtotime($to))}}</h4>
			    ...
			    <table class="table table-hover table-bordered" style="margin-top: 10px">
						<thead>
							...
							<tr>
							      <td><a href="{{route('admin.home',['id_user'=>$pad_stat->pad])}}">{{$pad_stat->name}}</a></td>
								  <td>
								 ...
								 <td>
								 {{-- <a href="{{route('advert_statistic.partner_statistic', ['id'=>$pad_stat->pad])}}" data-toggle="tooltip" data-placement="bottom" title="Статистика по дням" target="_blank"><span class="glyphicon glyphicon-th news-gliph-all color-blue"></span></a> --}}
								 
								 <a href="{{route('product_statistic.product_detail_user_one', ['id'=>$pad_stat->pad])}}" data-toggle="tooltip" data-placement="bottom" title="Статистика по дням" target="_blank"><span class="glyphicon glyphicon-th news-gliph-all color-blue"></span></a>
