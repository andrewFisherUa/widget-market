...
<div class="container">
	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="row">
				<h4 class="text-center">Cтатистика по площадке <a href="{{route('pads.edit', ['id'=>$pad->id])}}" target="_blank">{{$pad->domain}}</a> по тизерным виджетам в период с {{date('d-m-Y',strtotime($from))}} по {{date('d-m-Y',strtotime($to))}}</h4>
