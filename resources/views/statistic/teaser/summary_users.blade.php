...
<div class="container">
	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="row">
				<h4 class="text-center">Cтатистика по партнерам по тизерным виджетам в период с {{date('d-m-Y',strtotime($from))}} по {{date('d-m-Y',strtotime($to))}}</h4>
				<div class="col-xs-12">
									...
									<tbody>
										...
										@foreach ($summaryStats as $summaryStat)
											<tr>
												...
												<td><a href="{{route('teaser_statistic.teaser_detail_user_one', ['id'=>$summaryStat->user_id])}}" target="_blank">
