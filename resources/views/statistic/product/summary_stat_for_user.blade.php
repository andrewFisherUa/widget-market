...
<div class="container">
	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="row">
				<h4 class="text-center">Статистика <a href="{{route('admin.home', ['user_id'=>$userP->id])}}" target="_blank">{{$userP->name}}</a> по товарным виджетам в период с {{date('d-m-Y',strtotime($from))}} по {{date('d-m-Y',strtotime($to))}}</h4>
