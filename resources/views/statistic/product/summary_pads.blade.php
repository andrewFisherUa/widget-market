									...
									<tbody>
										...
										@foreach ($summaryStats as $summaryStat)
											<tr>
												...
												<td><a href="{{route('product_statistic.product_detail_pad_one', ['id'=>$summaryStat->pad_id])}}" target="_blank">
								...
								<table class="table table-hover table-bordered" style="margin-top: 10px">
									...
									<tbody>
										...
										@foreach ($yandex_stats as $yandex_stat)
											<tr>
												<td><a href="{{route('pads.edit', ['id'=>$yandex_stat->pad_id])}}" target="_blank">{{$yandex_stat->domain}}</a></td>
												<td><a href="{{route('admin.home', ['user_id'=>$yandex_stat->user_id])}}" target="_blank">{{$yandex_stat->name}}</a></td>
												<td>
													@if ($yandex_stat->manager)
														<a href="{{route('admin.home', ['user_id'=>$yandex_stat->manager])}}" target="_blank">{{\App\User::find($yandex_stat->manager)->name}}</a>
													@endif
												</td>
												...
												<td><a href="{{route('product_statistic.product_detail_pad_one', ['id'=>$yandex_stat->pad_id])}}" target="_blank">
													<span class="glyphicon glyphicon-th news-gliph-all color-blue"></span>
												</a></td>
											</tr>
										@endforeach
								...
								<table class="table table-hover table-bordered" style="margin-top: 10px">
									...
									<tbody>
										...
										@foreach ($ta_stats as $ta_stat)
											<tr>
												<td><a href="{{route('pads.edit', ['id'=>$ta_stat->pad_id])}}" target="_blank">{{$ta_stat->domain}}</a></td>
												<td><a href="{{route('admin.home', ['user_id'=>$ta_stat->user_id])}}" target="_blank">{{$ta_stat->name}}</a></td>
												<td>
													@if ($ta_stat->manager)
														<a href="{{route('admin.home', ['user_id'=>$ta_stat->manager])}}" target="_blank">{{\App\User::find($ta_stat->manager)->name}}</a>
													@endif
												</td>
												<td>{{$ta_stat->views}}</td>
												...
												<td>{{$ta_stat->cpc}}</td>
												<td>{{$ta_stat->summa}}</td>
												<td><a href="{{route('product_statistic.product_detail_pad_one', ['id'=>$ta_stat->pad_id])}}" target="_blank">
													<span class="glyphicon glyphicon-th news-gliph-all color-blue"></span>
												</a></td>
											</tr>
										@endforeach
