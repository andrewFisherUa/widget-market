								...
								<table class="table table-hover table-bordered" style="margin-top: 10px">
									...
									<tbody>
										<tr style="background: #000; color: #fff;">
											<td colspan="2" style="text-align: left">Всего</td>
										...
										@foreach ($summaryStats as $summaryStat)
											<tr>
												...
												<td><a href="{{route('product_statistic.product_detail_user_one', ['id'=>$summaryStat->user_id])}}" target="_blank">
									...
									<tbody>
										...
										@foreach ($yandex_stats as $yandex_stat)
											<tr>
												...
												<td><a href="{{route('product_statistic.product_detail_user_one', ['id'=>$yandex_stat->user_id])}}" target="_blank">
													<span class="glyphicon glyphicon-th news-gliph-all color-blue"></span>
												</a></td>
											</tr>
										@endforeach
									...
									<tbody>
										...
										@foreach ($ta_stats as $ta_stat)
											<tr>
												...
												<td>{{$ta_stat->cpc}}</td>
												<td>{{$ta_stat->summa}}</td>
												<td><a href="{{route('product_statistic.product_detail_user_one', ['id'=>$ta_stat->user_id])}}" target="_blank">
													<span class="glyphicon glyphicon-th news-gliph-all color-blue"></span>
												</a></td>
											</tr>
										@endforeach
