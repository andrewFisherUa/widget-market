<div id="add_affiliate_widget" class="modal fade user_add_widget">
	<div class="modal-dialog">
		...
		<div class="affiliate_modal_header">Создание виджета<button class="modal_exit glyphicon glyphicon-remove-sign" type="button" data-dismiss="modal" data-trigger="hover" data-toggle="tooltip" data-placement="bottom" title="Закрыть"></button></div>
			<hr class="modal_hr">
			<form class="form-horizontal" role="form" method="post" action="{{ route('widget.create')}}">
				...
				<div class="form-group">
					...
					{{$role=1}}
					@endif-->
					<div id="role" class="display: none" data-role="{{$role}}" hidden></div>
