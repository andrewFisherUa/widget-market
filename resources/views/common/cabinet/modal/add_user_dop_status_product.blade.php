<div id="add_user_dop_status_product_{{$userActive->user_id}}" class="modal fade">
		...
		<div class="affiliate_modal_header">Назначение дополнительного статуса<button class="modal_exit glyphicon glyphicon-remove-sign" type="button" data-dismiss="modal" data-toggle="tooltip" data-placement="bottom" title="Закрыть"></button></div>
			...
			<form class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-xs-6">
						<textarea name="text_for_dop_status" class="form-control" style="resize: none;">{{$userActive->text_for_dop_status}}</textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-ffset-1 col-xs-10 text-center">
					  <a data-set="{{$userActive->user_id}}" id="user_dop_status_submit" class="btn btn-primary">Сохранить</a>
					</div>
				</div>
			</form>
		</div>
