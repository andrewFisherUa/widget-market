...
@section('content')
	<div class="container">
		<div class="row">
			@include('helper.advertiser.top_menu')
		</div>
		<div class="row">
			<div class="col-xs-12">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<li class="heading text-left active"><a href="#product" data-toggle="tab"></a></li>
...
<script src="//partner.market-place.su/last_helper/reference/advertiser/helper.js"></script>
<script>
