				<div class="row">
					...
					<div class="form-group">
						...
						<div class="col-xs-7">
							<div class="radio_buttons">
								<div>
									<input type="radio" name="form" id="radio1" @if($requisite->type_org==1) checked @endif value="1">
									<label for="radio1">ИП</label>
								</div>
								<div>
									<input type="radio" name="form" id="radio2" @if($requisite->type_org==2) checked @endif value="2">
					...
					<div class="form-group" data-set="nds">
						...
						<div class="col-xs-7">
							<div class="radio_buttons1">
								<div>
									<input type="radio" name="nds" value="1" @if($requisite->type_payout==1) checked @endif id="pay_rad1">
									<label for="pay_rad1">без НДС</label>
								</div>
								<div>
									<input type="radio" name="nds" value="2" @if($requisite->type_payout==2) checked @endif id="pay_rad2">
					...
					<div class="form-group" data-set="position">
						...
						<div class="col-xs-7">
							<select class="form-control" name="position" style="margin-top: 12px;">
                                @if($requisite->type_org==1)
								<option value="Руководитель">Руководитель</option>
                                @else
                                <option value="Руководитель" @if($requisite->position=="Руководитель")selected @endif>Руководитель</option>
								<option value="Директор" @if($requisite->position=="Директор")selected @endif>Директор</option>
								<option value="Генеральный директор" @if($requisite->position=="Генеральный директор")selected @endif>Генеральный директор</option>
                                @endif
							</select>
						</div>
					</div>
					<div class="form-group @if ($errors->has('name')) has-error  @endif" data-set="name">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" name="name" value="{{$requisite->name}}">
					...
					<div class="form-group @if ($errors->has('firm_name')) has-error  @endif" data-set="firm_name">
						<label for="firm_name" class="col-xs-5 control-label">@if($requisite->type_org==1)ИП@elseПолное наименование организации@endif</label>
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->firm_name}}" name="firm_name" @if($requisite->type_org==1) readonly @endif>
					...
					<div class="form-group @if ($errors->has('legale_male')) has-error  @endif" data-set="legale_male">
						...
						<div class="col-xs-7">
							<textarea class="form-control" name="legale_male" style="height: 80px; resize: none">{{$requisite->legale_male}}</textarea>
                    ...
                    <div class="form-group @if ($errors->has('fact_male')) has-error  @endif" data-set="fact_male">
						...
						<div class="col-xs-7">
							<textarea class="form-control" name="fact_male" style="height: 80px; resize: none">{{$requisite->fact_male}}</textarea>
					...
					<div class="form-group @if ($errors->has('series_certificate')) has-error  @endif" data-set="series_certificate">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->series_certificate}}" name="series_certificate" style="margin-top: 12px;">
					...
					<div class="form-group @if ($errors->has('number_certificate')) has-error  @endif" data-set="number_certificate">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->number_certificate}}" name="number_certificate" style="margin-top: 12px;">
					...
					<div class="form-group @if ($errors->has('date_certificate')) has-error  @endif" data-set="date_certificate">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->date_certificate}}" name="date_certificate" style="margin-top: 20px;">
                    ...
                    <div class="form-group  @if ($errors->has('inn')) has-error  @endif" data-set="inn">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->inn}}" name="inn">
							@if ($errors->has('inn'))
								<span class="help-block">
					 ...
					 <div class="form-group  @if ($errors->has('kpp')) has-error  @endif" data-set="kpp">
						 ...
						 <div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->kpp}}" name="kpp">
							@if ($errors->has('kpp'))
								<span class="help-block">
					...
					<div class="form-group  @if ($errors->has('ogrn')) has-error  @endif" data-set="ogrn">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->ogrn}}" name="ogrn">
							@if ($errors->has('ogrn'))
								<span class="help-block">
					...
					<div class="form-group @if ($errors->has('okved')) has-error  @endif" data-set="okved">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->okved}}" name="okved">
							@if ($errors->has('okved'))
								<span class="help-block">
					...
					<div class="form-group @if ($errors->has('name_bank')) has-error  @endif" data-set="name_bank">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->name_bank}}" name="name_bank">
					...
					<div class="form-group @if ($errors->has('account')) has-error  @endif" data-set="account">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->account}}" name="account">
					...
					<div class="form-group @if ($errors->has('kor_account')) has-error  @endif" data-set="kor_account">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->kor_account}}" name="kor_account">
					...
					<div class="form-group @if ($errors->has('kor_account')) has-error  @endif" data-set="bik">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" value="{{$requisite->bik}}" name="bik">
							@if ($errors->has('bik'))
								<span class="help-block">
					...
					<div class="form-group" data-set="chstatus">
						...
						<div class="col-xs-1">
							<input type="text" class="form-control" name="dogovor">
					...
					<div class="form-group" data-set="chstatus">
						...
						<div class="col-xs-1">
							<input type="checkbox" class="form-control" name="chstatus" @if($requisite->improved) checked @endif>
