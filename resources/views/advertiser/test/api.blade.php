...
--}}
	   ...
	   <div class="row">
		...
		<div class ="container">
@foreach($resp["offers"] as $model)
<div class="row panel panel-primary">
  <div class="col-sm-9">
  {{$model["modelName"]}}
    <div class="row">
      <div class="col-2 col-sm-2">
	  <a rel="nofollow" href="{{$model['modelLink']}}" target="_blank" class="model-image-container">                              
	  <img class="model-image" src="{{$model['modelImg']}}">
	  </a>
      </div>
      <div class="col-10 col-sm-10">
        @foreach($model["links"] as $link)
		<div>{{$link['shopName']}}</div>
		<div>{{$link['price']}}</div>
