...
<head>
    ...
    <style>
        body {font-family: DejaVu Sans, sans-serif; width: 170mm;height:170mm; margin-left: auto; margin-right: auto; border: 1px #efefef solid; font-size: 11px;}
...
$localtop=20;	
@endphp
<div style="width: 170mm; padding:2mm;">
...
<div style="position:relative; width: 170mm;height:170mm" >
<div style="position:absolute;top:0mm;width:100%;height:35mm;">
<table style="calc(100% - 40mm);border:1px solid #000" cellpadding="2" cellspacing="2" class="invoice_bank_rekv">
    <tr>
        <td colspan="2" rowspan="2" style="min-height:13mm; width: 80mm;">
    ...
    <tr>
	    ...
	    <tr>
        <td style="min-height:6mm; height:auto; width: 39mm;">
            <div>ИНН {{$postavka["inn"]}}</div>
        </td>
        <td style="min-height:6mm; height:auto; width: 39mm;">
            <div>КПП {{$postavka["kpp"]}}</div>
        </td>
		<td rowspan="2" style="min-height:19mm; height:auto; vertical-align: top; width: 23mm;">
            <div>К/С</div>
        </td>
		<td rowspan="2" style="min-height:19mm; height:auto; vertical-align: top; width: 58mm;">
            <div>{{$postavka["ks"]}}</div>
        </td>
    </tr>
    <tr>
        <td colspan="2" style="min-height:13mm; height:auto;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="height: 13mm; width: 80mm;">
                <tr>
                    <td valign="top">
                        <div>
...
@if($inv->type==2)
<div style="position:absolute;top:38mm;width:170mm;height:{{$localtop}}mm; font-size: 10px;">	
<div style ="text-decoration:underline">Условия для расчётов:</div>
<div style ="font-size: 10px;padding-left:2mm">
<ol style="margin: 0;">
...
@endif	
<div style="position:absolute;top:{{(38+$localtop)}}mm;width:168mm;height:6mm;font-weight: bold; font-size: 15px;left:2mm">
...
<div style="position:absolute;top:{{(95+$localtop)}}mm;width:100%;height:16mm;">
...
<div style="position:absolute;top:{{(111+$localtop)}}mm;">
  Всего наименований 1 на сумму {{$inv->total}} рублей.<br />
   <span style="font-weight: 600;">{{$inv->summaToStr()}}</span></div>
<div style="position:absolute;top:{{(122+$localtop)}}mm;background-color:#000000; width:100%; font-size:1px; height:2px;">&nbsp;</div>	
<div style="position:absolute;top:{{(130+$localtop)}}mm;">Руководитель <span style="border-bottom: 1px solid #000; width:310px;display: inline-block;text-align: right;" >Осипов Д.А.</span></div>    
<div style="position:absolute;top:{{(141+$localtop)}}mm;">Главный бухгалтер <span style="border-bottom: 1px solid #000; width: 310px;display: inline-block;text-align: right;" >Осипов Д.А.</span> </div>
@if($inv->type==2)
<div style="position:absolute;top:{{(152+$localtop)}}mm;">Счет действителен к оплате в течении 14 календарных дней.</div>
@else
<div style="position:absolute;top:{{(152+$localtop)}}mm;">Счет действителен к оплате в течении трех дней.</div>
@endif	
