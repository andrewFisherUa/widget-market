...
<script type="text/javascript">
    $(document).ready(function() {
		...
		function profile(){
			$.post('/home_profile',{ _token: $('meta[name=csrf-token]').attr('content') }, function(response) {
		...
		function balance(){
			$.post('/home_balance',{ _token: $('meta[name=csrf-token]').attr('content') }, function(response) {
		...
		function notif(){
			$.post('/home_notif',{ _token: $('meta[name=csrf-token]').attr('content') }, function(response) {
		...
		function news(){
			$.post('/home_news',{ _token: $('meta[name=csrf-token]').attr('content') }, function(response) {
