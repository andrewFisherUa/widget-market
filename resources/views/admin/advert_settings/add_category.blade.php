...
<div class="container">
    ...
    <div class="row">
		<h4 class="text-center">Новая категория</u></h4>
    ...
    <div class="col-md-4 text-center">Название категории</div>
	<div class="col-md-4 text-center"><input name="name" type = "text" value="{{Request::old("name")}}"/></div>
	</div>
	</div>
    </div>
	...
	<textarea name ="templates" style="width:100%;max-width:100%" rows ="10">{{Request::old("templates")}}</textarea></div>
