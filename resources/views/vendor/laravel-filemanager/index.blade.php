...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('unisharp.lfm.upload',['user_id'=>$user_id]) }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
  ...
  <script>
	...
	lfm_route='/home/{{$user_id}}/laravel-filemanager';
