...
<body text="#000000" bgcolor="#ececec" style="color: #222222">
	...
	<div style="width: 600px; margin: 0 auto; background: #ffffff;">
		...
		<p>Добрый день!</p>
		<p>Обратили внимание что Вы уже долгое время к нам не заходили.</p>
		<p>Мы всегда стараемся улучшать наш сервис и будем благодарны за обратную связь, что Вам не понравилось в 
		работе с нами и что стоит изменить/добавить/убрать, чтобы быть лучше?</p>
