...
<div class="container">
    <div class="row">
		<form class="form-horizontal" role="form" method="post" action="{{ route('news.save')}}">
		{!! csrf_field() !!}
			<div class="col-xs-4">
				<div class="news_block">
					...
					<div class="form-group">
						...
						<div class="col-xs-2 custom-radio">
							<input name="role" value="1" class="controls" type="radio" checked>
						</div>
					</div>
					<div class="form-group">
						<label for="role" class="col-xs-10 control-label">Рекламодателям</label>
						<div class="col-xs-2 custom-radio">
							<input name="role" value="2" class="controls" type="radio">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-2 custom-radio">
							<input name="important" value="1" class="controls" type="radio" checked>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-xs-2 custom-radio">
							<input name="important" value="2" class="controls" type="radio">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-xs-2 custom-radio">
							<input name="important" value="3" class="controls" type="radio">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-2 custom-radio">
							<input name="type" value="1" class="controls" type="radio" checked>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-xs-2 custom-radio">
							<input name="type" value="4" class="controls" type="radio">
						</div>
					</div>
					<div class="form-group">
			...
			<div class="col-xs-8">
				<div class="form-group">
					...
					<div class="col-xs-12">
						<input id="osn_header" name="header" type="text" class="form-control" required>
					</div>
				</div>
				<div class="form-group">
					<label for="anoun" class="col-xs-12 text-center">Анонс</label>
					<div class="col-xs-12">
						<textarea name="anoun" class="form-control" maxlength="255" style="resize: none;" required></textarea>
					</div>
				</div>
				<div class="form-group">
					<label for="body" class="col-xs-12 text-center">Текст новости</label>
					<div class="col-xs-12">
						<textarea name="body" type="text" id="text_body" class="form-control" required></textarea>
					</div>
				</div>
			</div>
		</form>
			...
			<div role="tabpanel" class="tab-pane active" id="sait" style="padding: 20px;">
				<div class="col-xs-9">
					<div class="news_block_one">
						<div id="site_header" class="news_block_green_no_read news_one_header">
						<span id="gliph_one_n" class="glyphicon glyphicon-info-sign news-gliph-one-news color-blue"></span>
						<span id="site_text_header" class="text-center">Заголовок</span>
						</div>
						<div id="site_body" class="one_news_body">Текст</div>
					</div>
				</div>
			</div>
