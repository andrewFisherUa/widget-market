...
<body text="#000000" bgcolor="#ececec" style="color: #222222">
	...
	<div style="width: 600px; margin: 0 auto; background: #ffffff;">
		...
		Подтверждение регистрации рекламодателя.
		</div>
		<div style="padding: 10px; color: #222222; font-size: 14px;">
		<p>Спасибо за регистрацию на Market-Place.</p>
		<p><b>Для начала работы Вам необходимо подтвердить Ваш электронный адрес.</b></p>
		<p>Пожалуйста, перейдите по <a href="http://widget.market-place.su/register/confirm/{{$token}}" target="_blank">ссылке</a>, чтобы активировать Ваш аккаунт.</p>
		...
		<table style="width: 100%; padding: 10px;">
			...
			<tr>
				<td colspan="2" style="text-align: center; font-size: 14px; color: #222222;">© Market Place, 2015 - 2018</td>
			</tr>
		</table>
    </div>
    <br>
