...
class VideoStatet extends Command
{
...
private $groupPidsNoControl=[];
     ...
     * @var string
     */
    protected $signature = 'statistic:videostatet';
    ...
    public function handle()
    {
        ...
        $cmd ="cp -p /home/mp.su/statistic/videostatistic/statistic-video1533974252_2.log $tmp_file && cat /dev/null >  /home/mp.su/statistic/videostatistic/statistic-video1533974252_2.log";
		
		//$cmd ="cp -p /home/mp.su/statistic/videostatistic/statistic-video1533893761_.log $tmp_file && cat /dev/null >  /home/mp.su/statistic/videostatistic/statistic-video1533893761_.log";
		`$cmd`;
	    ...
	    $this->cacheEvents=[];
		//$tmp_file="/home/myrobot/data/videostatistic/statistic-video.log";
		$tmp_file="/home/mp.su/statistic/videostatistic/statistic-video1533974252_.log";
		...
		if ($handle) {
			...
			while (($buffer = fgets($handle, 4096)) !== false) {
				...
				if ($i>=1000000 && $i<2000000){
					$fileopen=fopen("/home/mp.su/statistic/videostatistic/statistic-video1533974252_2.log", "a+");
					fwrite($fileopen,$buffer);
					fclose($fileopen);
					//file_put_contents("/home/mp.su/statistic/videostatistic/statistic-video1533889390_1.log", $buffer);
				}
			}
		}
		var_dump($i);
