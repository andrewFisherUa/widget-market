...
class VideoStatisticPadsNewPlayer extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
		Schema::create('video_statistic_pads_new_player', function (Blueprint $table) {
		$table->increments('id');
		$table->date('date');
    ...
    {
        //
		Schema::dropIfExists('video_statistic_pads_new_player');
    }
}
