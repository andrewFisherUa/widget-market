...
var self=this;
console.log([22,params.calculated]); 
if(params.calculated){
	this.calculated=params.calculated; 
}
...
n2.innerHTML=''+this.calculated+' &nbsp; <a href="https://widget.market-place.su/rekrut-product/next/category/form/'+params.id+'" target="_blank">прав.</a>';
n2.style.position="absolute";
n2.style.right="0";
if(params.rule){
		n2.style.backgroundColor='#FF69FF';
}
dd1.appendChild(n2);
return this.li;
};
...
},{"./httpclient":1,"./nextnode":2}],4:[function(require,module,exports){
'use strict';
/**
 * Created by mambrin on 28.03.17.
 */
var mytree= require('./../models/nexttree');
