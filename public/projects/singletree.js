...
this.checkbox.onclick=function(){
	...
	this.checked = checke;
	//self.afterChecked.call(self);
//alert(self.oncheckFn); 
if(self.ul){
/*
 ...
 * Created by mambrin on 28.03.17.
 */
var mynode= require('./mysinglenode');
...
var url='https://widget2.market-place.su/admin/categories/0/open?data='+encodeURIComponent(JSON.stringify(args));
var self=this;
...
var url='https://widget2.market-place.su/admin/categories/0/research?data='+encodeURIComponent(JSON.stringify(args));
var self=this;
var parent=this.rootNode;
httpclient.ajax(url,{errorFn:function(res){
 console.log([1,'error',res]);
...
args=args||{};
var url='https://widget2.market-place.su/admin/categories';
...
var onCheckOpen = function(e){
	var lists=self.rootNode.ul.querySelectorAll("input[type='checkbox']");
...
},{"./httpclient":1,"./mysinglenode":2}],4:[function(require,module,exports){
'use strict';
/**
 * Created by mambrin on 28.03.17.
 */
var mytree= require('./../models/mysingletree');
